...
Public Class frmVendas_Inserir
        ...
        Try
            ...
            If constante > 0 Then
                ...
                While (leitor.Read)
                    ...
                    pnl(n_registo).Controls.Add(lbl(n_registo + 3))
                    AddHandler lbl(n_registo).Click, AddressOf ProdutoClicado
                    lbl(n_registo).Parent = pnl(n_registo)
    ...
    Private Sub ProdutoClicado(ByVal sender As Object, ByVal e As EventArgs)
        Dim lblx = DirectCast(sender, Label)
        ...
        'Try
        query = "select nome, stock, preco from produtos where codP=" + lblx.Tag
        comando = New MySqlCommand(query, ligacao)
        ...
        lbl(2) = New Label
        lbl(2).Location = New System.Drawing.Point(72, 27)
