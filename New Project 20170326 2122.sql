...
INSERT INTO `clientes` (`codC`,`nome`,`NIF`,`codLo`,`rua`,`ativado`,`telemovel`) VALUES 
 (1,'Tomás','123456789',1,'Rua Não Ramirez',0,'123456789'),
...
INSERT INTO `filmes` (`codFl`,`nome`,`atores`,`realizador`,`ano`,`duracao`,`codCs`,`preco`,`ativado`,`imagem`) VALUES 
 (2,'Assassin’s Creed','Michael Fassbender, Marion Cotillard, Jeremy Irons, Brendan Gleeson, Khalid Abdalla, Michael K. Williams','Justin Kurzel',2016,'01:55:00',3,5.56,NULL,NULL),
 (3,'O Pátio das Cantigas','Rui Unas, Miguel Guilherme, Anabela Moreira, César Mourão','Leonel Vieira',2015,'01:51:00',4,4.87,NULL,NULL),
 (4,'A Mãe é que Sabe','Maria João Abreu, Dalila Carmo, Manuel Cavaco, Bruno Cabrerizo, Margarida Carpinteiro','Nuno Rocha',2016,'01:28:00',3,4.56,NULL,NULL),
 (6,'Zeus','Sinde Filipe, Ivo Canelas, Catarina Luís, Paulo Pires','Paulo Filipe Monteiro',2016,'01:57:00',3,5.08,NULL,NULL),
 (7,'Cartas de Guerra','Miguel Nunes, Margarida Vila-Nova, Ricardo Pereira, João Pedro Vaz, Simão Cayatte','Ivo M. Ferreira',2016,'01:45:00',3,4.83,NULL,NULL),
 (8,'À Procura de Dory','Ellen DeGeneres, Albert Brooks, Ed O\'Neill','Andrew Stanton, Angus MacLane',2016,'01:37:00',1,4.42,NULL,NULL);
...
INSERT INTO `funcionarios` (`codF`,`nome`,`ordenado`,`telemovel`,`codE`,`palavra_passe`,`datanasc`,`rua`,`codLo`,`username`,`empregado`) VALUES 
 (1,'Parvo',700,'912345678',1,'1234','1999-11-11','Rua Filipa Lencastre',1,'PP',1),
 ...
 (4,'Luís Miguel',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1);
...
INSERT INTO `produtos` (`codP`,`nome`,`codG`,`stock`,`preco`,`ativado`,`imagem`) VALUES 
 (2,'Pipocas pequenas',1,45,1.5,NULL,NULL),
 (3,'Pipocas médias',1,40,2,NULL,NULL),
 (4,'Pipocas grandes',1,35,3,NULL,NULL),
 (5,'Sumol Ananás',2,67,0.65,NULL,NULL),
 (6,'Sumol Maracujá',2,45,0.75,NULL,NULL),
 (7,'Sumol Tropical',2,23,0.75,NULL,NULL),
 (8,'Sumol Frutos Vermelhos',2,10,0.8,NULL,NULL);
